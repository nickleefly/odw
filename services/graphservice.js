  ...
  var namespace = {
    ...
    */
    GetDataService: function(callback) {
      var query = "select sum(r.Rating) as ratings_sum, u.postalCode as postalCode from ratings r inner join users u on u.id = r.id where u.postalCode REGEXP '^-?[0-9]+$' and u.postalCode > 0 group by u.postalCode order by u.postalCode;";
